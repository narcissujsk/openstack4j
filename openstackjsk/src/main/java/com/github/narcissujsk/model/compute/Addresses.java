...
import com.github.narcissujsk.model.compute.Address;
...
public interface Addresses extends ModelEntity {
	 ...
	 */
	void add(String key, com.github.narcissujsk.model.compute.Address value);
	
	/**
	 * @return the a Map<String, List<Address> 
	 */
	Map<String, List<? extends com.github.narcissujsk.model.compute.Address>> getAddresses();
