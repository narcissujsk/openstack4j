...
import com.github.narcissujsk.core.transport.*;
import com.github.narcissujsk.core.transport.internal.HttpExecutor;
import com.github.narcissujsk.model.identity.AuthStore;
import com.github.narcissujsk.model.identity.AuthVersion;
import com.github.narcissujsk.model.identity.v3.Authentication;
import com.github.narcissujsk.model.identity.v3.Token;
import com.github.narcissujsk.openstack.common.Auth;
import com.github.narcissujsk.openstack.common.Auth.Type;
import com.github.narcissujsk.openstack.identity.v2.domain.Credentials;
import com.github.narcissujsk.openstack.identity.v2.domain.KeystoneAccess;
import com.github.narcissujsk.openstack.identity.v2.domain.RaxApiKeyCredentials;
import com.github.narcissujsk.openstack.identity.v3.domain.KeystoneAuth;
import com.github.narcissujsk.openstack.identity.v3.domain.KeystoneToken;
import com.github.narcissujsk.openstack.identity.v3.domain.TokenAuth;
import com.github.narcissujsk.openstack.internal.OSClientSession.OSClientSessionV2;
import com.github.narcissujsk.openstack.internal.OSClientSession.OSClientSessionV3;
...
public class OSAuthenticator {
    ...
    public static OSClient invoke(AuthStore auth, String endpoint, Facing perspective, Config config,
        ...
        if (auth.getVersion().equals(AuthVersion.V2)) {
            return authenticateV2((com.github.narcissujsk.openstack.identity.v2.domain.Auth) auth, info, config);
        }
     ...
     */
    @SuppressWarnings("rawtypes")
    public static OSClient invoke(com.github.narcissujsk.openstack.identity.v2.domain.TokenAuth auth, String endpoint,
    ...
    public static void reAuthenticate() {
        ...
        case V2:
            ...
            authenticateV2((com.github.narcissujsk.openstack.identity.v2.domain.Auth) auth, info, session.getConfig());
            break;
        case V3:
        default:
    ...
    private static OSClientV2 authenticateV2(com.github.narcissujsk.openstack.identity.v2.domain.Auth auth, SessionInfo info,
            Config config) {
        ...
        if (auth.getType() == Type.CREDENTIALS) {
            ...
            access = access.applyContext(info.endpoint, (com.github.narcissujsk.openstack.identity.v2.domain.TokenAuth) auth);
        }
