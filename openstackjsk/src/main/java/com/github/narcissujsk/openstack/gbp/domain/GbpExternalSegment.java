...
public class GbpExternalSegment implements ExternalSegment {
    ...
    private List<com.github.narcissujsk.openstack.gbp.domain.GbpExternalRoutes> externalRoutes;
    ...
    @Override
    public List<com.github.narcissujsk.openstack.gbp.domain.GbpExternalRoutes> getExternalRoutes() {
