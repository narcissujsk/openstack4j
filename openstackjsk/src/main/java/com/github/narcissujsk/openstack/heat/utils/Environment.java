package com.github.narcissujsk.openstack.heat.utils;

import com.fasterxml.jackson.core.JsonParseException;
import com.google.common.base.Charsets;
import com.google.common.io.Resources;
import com.github.narcissujsk.openstack.heat.utils.Template;
import com.github.narcissujsk.openstack.heat.utils.TemplateUtils;
...
public class Environment {
    ...
    private void getFileContent()
        ...
        for(String resourceType: rr.keySet()) {
            ...
            com.github.narcissujsk.openstack.heat.utils.Template tpl = new Template(tplUrl);
