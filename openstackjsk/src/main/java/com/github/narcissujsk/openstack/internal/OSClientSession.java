package com.github.narcissujsk.openstack.internal;

import com.google.common.annotations.VisibleForTesting;
import com.google.common.collect.Iterables;
import com.google.common.collect.Sets;
import com.github.narcissujsk.api.Apis;
import com.github.narcissujsk.api.EndpointTokenProvider;
import com.github.narcissujsk.api.OSClient;
import com.github.narcissujsk.api.OSClient.OSClientV2;
import com.github.narcissujsk.api.OSClient.OSClientV3;
...
import com.github.narcissujsk.api.client.CloudProvider;
import com.github.narcissujsk.api.compute.ComputeService;
...
import com.github.narcissujsk.api.identity.EndpointURLResolver;
import com.github.narcissujsk.api.image.ImageService;
import com.github.narcissujsk.api.magnum.MagnumService;
import com.github.narcissujsk.api.manila.ShareService;
import com.github.narcissujsk.api.murano.v1.AppCatalogService;
import com.github.narcissujsk.api.networking.NetworkingService;
import com.github.narcissujsk.api.networking.ext.ServiceFunctionChainService;
import com.github.narcissujsk.api.octavia.OctaviaService;
import com.github.narcissujsk.api.sahara.SaharaService;
import com.github.narcissujsk.api.senlin.SenlinService;
import com.github.narcissujsk.api.storage.BlockStorageService;
import com.github.narcissujsk.api.storage.ObjectStorageService;
import com.github.narcissujsk.api.tacker.TackerService;
import com.github.narcissujsk.api.telemetry.TelemetryAodhService;
import com.github.narcissujsk.api.telemetry.TelemetryService;
import com.github.narcissujsk.api.trove.TroveService;
import com.github.narcissujsk.api.types.Facing;
import com.github.narcissujsk.api.types.ServiceType;
import com.github.narcissujsk.api.workflow.WorkflowService;
import com.github.narcissujsk.core.transport.Config;
import com.github.narcissujsk.model.identity.AuthVersion;
import com.github.narcissujsk.model.identity.URLResolverParams;
import com.github.narcissujsk.model.identity.v2.Access;
import com.github.narcissujsk.model.identity.v3.Token;
import com.github.narcissujsk.openstack.identity.internal.DefaultEndpointURLResolver;
...
public abstract class OSClientSession<R, T extends OSClient<T>> implements EndpointTokenProvider {
    ...
    public com.github.narcissujsk.api.image.v2.ImageService imagesV2() {
    ...
    public static class OSClientSessionV2 extends OSClientSession<OSClientSessionV2, OSClientV2> implements OSClientV2 {
         ...
         */
        @Override
        public com.github.narcissujsk.api.identity.v2.IdentityService identity() {
        ...
        public Set<ServiceType> getSupportedServices() {
            if (supports == null) {
                supports = Sets.immutableEnumSet(Iterables.transform(access.getServiceCatalog(),
                        new com.github.narcissujsk.openstack.identity.v2.functions.ServiceToServiceType()));
            }
            return supports;
        }
    ...
    public static class OSClientSessionV3 extends OSClientSession<OSClientSessionV3, OSClientV3> implements OSClientV3 {
         ...
         */
        @Override
        public com.github.narcissujsk.api.identity.v3.IdentityService identity() {
        ...
        public Set<ServiceType> getSupportedServices() {
            if (supports == null) {
                supports = Sets.immutableEnumSet(Iterables.transform(token.getCatalog(),
                        new com.github.narcissujsk.openstack.identity.v3.functions.ServiceToServiceType()));
            }
            return supports;
        }
