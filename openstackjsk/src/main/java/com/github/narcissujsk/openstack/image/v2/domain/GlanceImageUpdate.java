package com.github.narcissujsk.openstack.image.v2.domain;
...
public class GlanceImageUpdate implements ImageUpdate {
    ...
    List<com.github.narcissujsk.openstack.image.v2.domain.PatchOperation> ops = new ArrayList<>();
    ...
    public GlanceImageUpdate(JsonNode value) {
        if (value.isArray()){
            for(Iterator<JsonNode> iterator = value.iterator(); iterator.hasNext();) {
                ...
                iterator.remove();
                com.github.narcissujsk.openstack.image.v2.domain.PatchOperation p = new com.github.narcissujsk.openstack.image.v2.domain.PatchOperation(
                        com.github.narcissujsk.openstack.image.v2.domain.PatchOperation.OperationType.value(next.get("op").textValue()),
    ...
    public GlanceImageUpdate(List<com.github.narcissujsk.openstack.image.v2.domain.PatchOperation> ops) {
        this.ops = ops;
    }
    ...
    @Override
    @JsonValue
    public List<com.github.narcissujsk.openstack.image.v2.domain.PatchOperation> getOps() {
        return ops;
    }
    ...
    public static class ImageUpdateConcreteBuilder implements ImageUpdateBuilder {
         ...
         */
        @Override
        public ImageUpdateBuilder ops(List<com.github.narcissujsk.openstack.image.v2.domain.PatchOperation> ops) {
            m.ops = ops;
            return this;
        }
