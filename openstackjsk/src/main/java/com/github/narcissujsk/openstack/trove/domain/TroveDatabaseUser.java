package com.github.narcissujsk.openstack.trove.domain;
...
public class TroveDatabaseUser implements DatabaseUser {
    ...
    List<com.github.narcissujsk.openstack.trove.domain.TroveDatabase> troveDatabaseList;
    ...
    public List<com.github.narcissujsk.openstack.trove.domain.TroveDatabase> getTroveDatabaseList() {
        return troveDatabaseList;
    }

    public void setTroveDatabaseList(List<com.github.narcissujsk.openstack.trove.domain.TroveDatabase> troveDatabaseList) {
