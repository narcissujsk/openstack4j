...
import com.github.narcissujsk.api.exceptions.RegionEndpointNotFoundException;
...
public interface OSClient< T extends OSClient<T>> {
     ...
     */
    com.github.narcissujsk.api.image.v2.ImageService imagesV2();
    ...
    public interface OSClientV2 extends OSClient<OSClientV2> {
         ...
         */
        com.github.narcissujsk.api.identity.v2.IdentityService identity();
    ...
    public interface OSClientV3 extends OSClient<OSClientV3> {
         ...
         */
        com.github.narcissujsk.api.identity.v3.IdentityService identity();
