package com.github.narcissujsk.api;
...
import com.github.narcissujsk.model.barbican.Secret;
import com.github.narcissujsk.model.barbican.builder.ContainerCreateBuilder;
import com.github.narcissujsk.model.barbican.builder.ContainerSecretBuilder;
import com.github.narcissujsk.model.barbican.builder.SecretCreateBuilder;
...
import com.github.narcissujsk.model.compute.builder.*;
import com.github.narcissujsk.model.dns.v2.builder.DNSV2Builders;
import com.github.narcissujsk.model.dns.v2.builder.RecordsetBuilder;
import com.github.narcissujsk.model.dns.v2.builder.ZoneBuilder;
import com.github.narcissujsk.model.gbp.builder.ExternalPolicyBuilder;
...
import com.github.narcissujsk.model.gbp.builder.L2PolicyBuilder;
import com.github.narcissujsk.model.gbp.builder.L3PolicyBuilder;
import com.github.narcissujsk.model.gbp.builder.NatPoolBuilder;
import com.github.narcissujsk.model.gbp.builder.NetworkServicePolicyBuilder;
import com.github.narcissujsk.model.gbp.builder.PolicyActionCreateBuilder;
...
import com.github.narcissujsk.model.gbp.builder.PolicyClassifierUpdateBuilder;
import com.github.narcissujsk.model.gbp.builder.PolicyRuleBuilder;
import com.github.narcissujsk.model.gbp.builder.PolicyRuleSetBuilder;
import com.github.narcissujsk.model.gbp.builder.PolicyTargetBuilder;
import com.github.narcissujsk.model.gbp.builder.PolicyTargetGroupBuilder;
import com.github.narcissujsk.model.heat.*;
import com.github.narcissujsk.model.heat.builder.*;
import com.github.narcissujsk.model.identity.v2.builder.IdentityV2Builders;
import com.github.narcissujsk.model.identity.v3.builder.*;
import com.github.narcissujsk.model.image.builder.ImageBuilder;
import com.github.narcissujsk.model.image.v2.builder.ImageUpdateBuilder;
import com.github.narcissujsk.model.image.v2.builder.TaskBuilder;
import com.github.narcissujsk.model.magnum.BaymodelBuilder;
import com.github.narcissujsk.model.manila.builder.*;
...
import com.github.narcissujsk.model.network.builder.*;
import com.github.narcissujsk.model.network.ext.builder.*;
import com.github.narcissujsk.model.sahara.builder.*;
import com.github.narcissujsk.model.storage.block.builder.BlockQuotaSetBuilder;
import com.github.narcissujsk.model.storage.block.builder.StorageBuilders;
import com.github.narcissujsk.model.storage.block.builder.VolumeBackupCreateBuilder;
import com.github.narcissujsk.model.storage.block.builder.VolumeBuilder;
import com.github.narcissujsk.model.storage.block.builder.VolumeSnapshotBuilder;
import com.github.narcissujsk.model.storage.block.builder.VolumeTypeBuilder;
...
import com.github.narcissujsk.model.telemetry.builder.TelemetryBuilders;
import com.github.narcissujsk.model.trove.builder.DBServiceBuilders;
import com.github.narcissujsk.openstack.artifact.domain.ArtifactUpdateModel;
import com.github.narcissujsk.openstack.artifact.domain.ToscaTemplates;
import com.github.narcissujsk.model.workflow.builder.WorkflowBuilders;
import com.github.narcissujsk.openstack.barbican.domain.BarbicanContainer;
import com.github.narcissujsk.openstack.barbican.domain.BarbicanContainerSecret;
import com.github.narcissujsk.openstack.barbican.domain.BarbicanSecret;
...
import com.github.narcissujsk.openstack.compute.builder.NovaBuilders;
import com.github.narcissujsk.openstack.compute.domain.*;
import com.github.narcissujsk.openstack.compute.domain.NovaSecGroupExtension.SecurityGroupRule;
import com.github.narcissujsk.openstack.compute.domain.NovaServerCreate;
import com.github.narcissujsk.openstack.dns.v2.builder.DesignateV2Builders;
import com.github.narcissujsk.openstack.dns.v2.domain.DesignateRecordset;
import com.github.narcissujsk.openstack.dns.v2.domain.DesignateZone;
import com.github.narcissujsk.openstack.gbp.domain.GbpExternalPolicyCreate;
...
import com.github.narcissujsk.openstack.gbp.domain.GbpL2Policy;
import com.github.narcissujsk.openstack.gbp.domain.GbpL3Policy;
import com.github.narcissujsk.openstack.gbp.domain.GbpNatPool;
import com.github.narcissujsk.openstack.gbp.domain.GbpNetworkServicePolicy;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyAction;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyActionUpdate;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyClassifier;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyClassifierUpdate;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyRule;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyRuleSet;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyTarget;
import com.github.narcissujsk.openstack.gbp.domain.GbpPolicyTargetGroupCreate;
import com.github.narcissujsk.openstack.heat.builder.HeatBuilders;
import com.github.narcissujsk.openstack.heat.domain.*;
import com.github.narcissujsk.openstack.identity.v2.builder.KeystoneV2Builders;
import com.github.narcissujsk.openstack.identity.v3.builder.KeystoneV3Builders;
import com.github.narcissujsk.openstack.identity.v3.domain.*;
import com.github.narcissujsk.openstack.image.domain.GlanceImage;
import com.github.narcissujsk.openstack.image.v2.domain.GlanceImageUpdate;
import com.github.narcissujsk.openstack.image.v2.domain.GlanceTask;
import com.github.narcissujsk.openstack.magnum.MagnumBaymodel;
import com.github.narcissujsk.openstack.manila.builder.ManilaBuilders;
import com.github.narcissujsk.openstack.manila.domain.*;
import com.github.narcissujsk.openstack.murano.v1.builder.MuranoBuilders;
import com.github.narcissujsk.openstack.murano.v1.domain.MuranoEnvironment;
import com.github.narcissujsk.openstack.networking.builder.NeutronBuilders;
import com.github.narcissujsk.openstack.networking.domain.*;
import com.github.narcissujsk.openstack.networking.domain.ext.*;
import com.github.narcissujsk.openstack.octavia.builder.OctaviaBuilders;
import com.github.narcissujsk.openstack.sahara.builder.SaharaBuilders;
import com.github.narcissujsk.openstack.sahara.domain.*;
import com.github.narcissujsk.openstack.storage.block.builder.CinderBuilders;
import com.github.narcissujsk.openstack.storage.block.domain.CinderBlockQuotaSet;
import com.github.narcissujsk.openstack.storage.block.domain.CinderVolume;
import com.github.narcissujsk.openstack.storage.block.domain.CinderVolumeBackupCreate;
import com.github.narcissujsk.openstack.storage.block.domain.CinderVolumeSnapshot;
import com.github.narcissujsk.openstack.storage.block.domain.CinderVolumeType;
import com.github.narcissujsk.openstack.tacker.builders.TackerBuilders;
import com.github.narcissujsk.openstack.telemetry.builder.CeilometerBuilders;
import com.github.narcissujsk.openstack.telemetry.domain.CeilometerAlarm;
import com.github.narcissujsk.openstack.trove.builder.TroveBuilders;
import com.github.narcissujsk.openstack.workflow.builder.MistralBuilders;
...
public class Builders {
     ...
     */
    public static com.github.narcissujsk.model.image.v2.builder.ImageBuilder imageV2() {
        return com.github.narcissujsk.openstack.image.v2.domain.GlanceImage.builder();
    }
